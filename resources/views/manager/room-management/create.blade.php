...
<div class="container mb-5">
    <div class="row">
        <div class="col-md-12">
            ...
            <form method="post" action="/room-management" enctype="multipart/form-data">
                @csrf

                <div class="form-group row">
                    <label for="room_number" class="col-12 col-form-label">Room Number</label>
                    <div class="col-12">
                        <input value="{{ old('room_number') }}" id="room_number" name="room_number"
                            placeholder="Room number" class="form-control  @error('room_number') is-invalid @enderror"
                            type="text">
                        @error('room_number')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-12">
                        <input value="{{ old('price') }}" id="price" name="price" placeholder="Price"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-12">
                        <input value="{{ old('category_type') }}" id="category_type" name="category_type"
                            placeholder="Category type like presidential, resident..."
                ...
                <div class="form-group row">
                    ...
                    <div class="col-12">
                        <textarea name="room_detail_type" class="editor" rows="10"
                            value="{!! old('room_detail_type') !!}"></textarea>
                    </div>
                ...
                <div class="form-group row">
                    <div class="col-12">
                        <button name="submit" type="submit" class="btn btn-primary">Add Room</button>
                    </div>
                </div>
